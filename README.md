...
|-----------------------------|------------------------------------------------------------------------------------------------------|-------------------|
| 🏓 **[transcendence](https://github.com/lcssbrs/ft_transcendence/tree/tom)**  | A multiplayer pong game built with real-time WebSockets for dynamic player interactions.         | *Django, PostgreSQL, WebSockets, etc..* |
